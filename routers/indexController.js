...
exports.showIndexPage = (req, res) => {
  ...
  mysqlPool.pool.getConnection((err, connection) => {
    ...
    query += "p.prj_name, p.prj_content, p.cls_date, p.start_date, p.keyword1, p.keyword2, p.keyword3, m.mentor_name, m.company_name,team_pj.team_name as team_id from project as p "
